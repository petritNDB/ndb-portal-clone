      ...
      <Container>
        ...
        <div className="gridOverlay__head">
          ...
          <p className="grid-desc">
            The NDB safety strategy has been built to fulfill the international
            nuclear safety standards associated with systems, equipment, or
            materials according to three main strategies{" "}
          </p>
        </div>
      </Container>
